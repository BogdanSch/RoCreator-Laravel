...
@section('main_content')
    <section class="contacts">
        <div class="container">
            <div class="contacts__wrap">
                ...
                <form action="https://sheetdb.io/api/v1/97uitw1pohok4" method="post" accept-charset="UTF-8"
                    class="contacts__form" data-aos="fade-up" data-aos-duration="2000">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="message" id="message" rows="15" class="contacts__form-text" required></textarea>
                        </div>
    ...
    <section class="contacts-map" data-aos="zoom-in-up" data-aos-duration="2500">
